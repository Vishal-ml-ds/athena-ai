...
export function Sidebar({ onNotificationClick, isOpen, onClose }: SidebarProps) {
      ...
      >
        ...
        <div className="flex items-center gap-3 p-6">
          <div
            className={cn(
              ...
              "bg-primary-container shadow-[0_0_20px_rgba(124,58,237,0.3)]"
            )}
          >
          ...
          <div className="flex-1">
            ...
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-athena-primary/60">
          ...
          <button
            ...
            className="relative hidden rounded-full p-2 text-violet-400 transition-colors hover:text-amber-400 md:block"
          >
        ...
        <div className="mb-4 px-4">
          <button
            ...
            className={cn(
              ...
              "rounded-xl bg-primary-container px-4 py-3",
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto px-3">
          ...
          {conversations.length === 0 && (
            <p className="px-3 py-4 text-center font-mono text-xs text-outline">
              No chats yet
            </p>
          )}
        </nav>
